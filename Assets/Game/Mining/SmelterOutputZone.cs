...
namespace IndustryTycoon.Mining
{
    ...
    public sealed class SmelterOutputZone : MonoBehaviour
    {
        ...
        public bool TryTransferOne()
        {
            return isActiveAndEnabled
                   ...
                   && smelter != null
                   && carryStack != null
                   && smelter.TryTransferOutputTo(carryStack);
        }
        ...
        private void TryStartTransfer()
        {
            if (!isActiveAndEnabled
                ...
                || smelter.OutputBars <= 0
                || !carryStack.CanAccept(ResourceType.IronBar, 1))
            {
                return;
            }
        ...
        private IEnumerator TransferRoutine()
        {
            ...
            {
                if (!smelter.TryTransferOutputTo(carryStack))
                {
                    break;
                }
