...
namespace IndustryTycoon.Processing
{
    ...
    public sealed class PackingStationOutputZone : MonoBehaviour
    {
        ...
        public bool TryTransferOne()
        {
            return isActiveAndEnabled
                   ...
                   && packingStation != null
                   && carryStack != null
                   && packingStation.TryTransferOutputTo(carryStack);
        }
        ...
        private void TryStartTransfer()
        {
            ...
            if (!packingStation.isActiveAndEnabled
                || packingStation.OutputCrates <= 0
                || !carryStack.CanAccept(ResourceType.Crate, 1))
            {
                return;
            }
        ...
        private IEnumerator TransferRoutine()
        {
            ...
            {
                if (!packingStation.TryTransferOutputTo(carryStack))
                {
                    break;
                }
